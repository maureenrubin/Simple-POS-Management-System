...
namespace WindowsApp.Resources {
...
namespace WindowsApp.Resources.NewAppDataSet1TableAdapters {
...
SELECT id, fname, lname, username, password, contact, type FROM tb_Staff WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, fname, lname, username, password, contact, type FROM dbo.tb_Staff";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
